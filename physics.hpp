...
/** Stagnation pressure: p0 = rho0 * a0^2 / gamma */
 ...
 * u = M*a*cos(alpha), v = M*a*sin(alpha), a = sqrt(gamma*p/rho)
 */
...
void physicalFlux(const double U[4], const double n[2], double gamma, double Fout[4]);
