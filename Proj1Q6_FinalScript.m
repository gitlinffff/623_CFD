[nelem,xelem,yelem,nedges,xedge,yedge,ledges,elemedge,BCs,Bcxelem,Bcyelem,LBF,PeriG] = readgri('refsmooth3.gri');
...
nbfgrp = 8;
creategri(refelem,nnodes,xnode,ynode,nodecon,nbfgrp,LBF,BCs,Bcxelem,Bcyelem,'uniRef-8k.gri')
%plot_fast('uniRef-128k.gri')
